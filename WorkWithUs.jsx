...
async function sendToTelegram(form) {
  if (!TELEGRAM_BOT_TOKEN || !TELEGRAM_CHAT_ID) {
    throw new Error("إعدادات Telegram غير مكتملة.");
  }
...
export default function WorkWithUs() {
  ...
  useEffect(() => {
    ...
    const updateVisibility = () => {
      ...
      setShowMobileCTA(!formIsVisible);
    };
  ...
  const handleSubmit = async (event) => {
    ...
    if (!whatsappRegex.test(form.whatsapp.trim())) {
      setError("أدخل رقم WhatsApp بصيغة دولية، مثال: +213555123456");
    ...
    if (!websiteValid) {
      setError("أدخل رابط موقع صحيح يبدأ بـ https:// أو http://");
        ...
        <div className="mx-auto flex min-h-[90vh] max-w-3xl items-center">
          <div className="w-full rounded-[32px] border border-white/10 bg-white p-7 text-center shadow-[0_30px_100px_rgba(0,0,0,0.4)] sm:p-12 md:p-16">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg font-medium leading-9 text-slate-600 md:text-xl">
              ...
              خلال ساعة واحدة لاستكمال التفاصيل والإجراءات اللازمة لبدء العمل.
            </p>
    ...
    >
      ...
      <section className="bg-white px-4 py-16 sm:px-6 md:py-28 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-9 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
            <div>
              <span className="text-[20px] font-black text-blue-600 md:text-lg">
                قبل أن تبدأ
              </span>
          ...
          <div className="mt-10 grid gap-4 sm:mt-14 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-[24px] border border-white/10 bg-white/[0.035] p-7 transition-all duration-300 hover:-translate-y-1 hover:border-blue-400/30 hover:bg-blue-500/[0.06]"
                >
      ...
      >
        <div className="mx-auto max-w-5xl">
          ...
          <form
            ...
            className="mt-10 rounded-[30px] border-2 border-slate-200 bg-white p-4 shadow-[0_25px_70px_rgba(15,23,42,0.08)] sm:p-7 md:p-10"
          >
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                required
                rows={5}
                placeholder="مثال: تكلفة الطلب مرتفعة، الحملات لا تتوسع، الكرياتيفات لا تحقق نتائج..."
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                minLength={100}
                rows={8}
                placeholder="اشرح لنا طبيعة مشروعك، منذ متى تعمل، المنتجات التي تبيعها، السوق المستهدف، النتائج الحالية..."
            ...
            <button
              ...
              className="mt-6 flex h-[68px] w-full items-center justify-center gap-3 rounded-2xl bg-blue-600 px-5 text-[18px] font-black text-white shadow-xl shadow-blue-600/20 transition-all hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-40 md:h-[74px] md:px-6 md:text-xl"
            >
              {status === "loading" ? (
                <>
      ...
      <section className="relative overflow-hidden bg-[#05091a] px-4 py-16 text-center text-white sm:px-6 md:py-28 lg:px-8">
        <div className="relative mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-[18px] font-semibold leading-8 text-slate-300 md:text-xl md:leading-10">
            أرسل معلومات مشروعك وسنراجعها ونتواصل معك لاستكمال التفاصيل.
          </p>

          <button
            type="button"
            onClick={scrollToApplication}
            className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-8 py-3 text-[18px] font-black text-white shadow-[0_16px_40px_rgba(37,99,235,0.35)] transition hover:bg-blue-500 sm:px-9"
          >
            ابدأ الآن
            <ArrowLeft size={23} />
          </button>
      ...
      {showMobileCTA && (
        <button
          type="button"
          onClick={scrollToApplication}
          className="fixed bottom-2 left-7 right-7 z-50 flex h-12 items-center justify-center gap-3 rounded-xl border border-blue-400/25 bg-blue-600 px-5 text-[15px] font-black text-white shadow-[0_10px_30px_rgba(37,99,235,0.35)] md:hidden"
